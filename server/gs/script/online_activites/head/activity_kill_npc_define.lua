AKCD_TABLE = {
	...
	[145] = {
		...
		tAward = {
			...
			tFreeRoom = {0, 2},
			tAwardFunc = {
				[1] = "fakct_Award201501_GetAward_1()",
				[2] = "fakct_Award201501_GetAward_2()",
			},
			tSpecial = {
				bIsOpen = 0,
				nRebornLimitUp = 0,
		...
		tTaskStep = {
			[1] = {
				szTargetNpcName = "Lôc Tróc ¤ng",
				szNpcPosName = "T­¬ng D­¬ng196/181",
				szTargetNpcTitle = "Yªu qu¸i hoµnh hµnh, d©n chóng lÇm than, ®¹i hiÖp h·y tiªu diÖt chóng ®Ó tr¶ l¹i sù b×nh yªn cho b¸ t¸nh",
				tTaskIndex = {4, 5}, --Ê¹ÓÃµÄÈÎÎñ±äÁ¿Ë÷Òý¼ÇÂ¼É±¹Ö¸öÊý
				KillNpc = {
					[1] = {
			...
			[2] = {
				szTargetNpcName = "Tæng binh",
				szNpcPosName = "T­¬ng D­¬ng189/187",
				szTargetNpcTitle = "L­u manh trong Thiªn TÇm Th¸p hµ hiÕp danh lµnh, ®¹i hiÖp h·y ®i tiªu diÖt chóng",
				tTaskIndex = {6, 7}, --Ê¹ÓÃµÄÈÎÎñ±äÁ¿Ë÷Òý¼ÇÂ¼É±¹Ö¸öÊý
				KillNpc = {
					[1] = {
	...
	[150] = {
		...
		tAward = {
			nAwardTag = 3, --Áì½±×´Ì¬0Î´ÁìÈ¡1ÁìÈ¡2ÒÑÁìÈ¡ÌØÊâ
			tDialog = {
				[1] = "Hoµn thµnh nhiÖm vô (Tiªu hao 299 Tiªu Dao Ngäc)",
			},
			tCost = {
				[1] = {{2, 1, 30603, 299, "Tiªu Dao Ngäc"}},
			},
			tFreeRoom = {2,},
			tAwardFunc = {
				[1] = "fakct_Award201503_GetAward()",
			},
			tSpecial = {
				bIsOpen = 0,
				nRebornLimitUp = 0,
		...
		tTaskStep = {
			...
			[3] = {
				szTargetNpcName = "§Ö Tö C«n L«n",
				szNpcPosName = "Thiªn S­ BÝ C¶nh 217/214",
				szTargetNpcTitle = "Tµng B¶o §å µ? Ta quªn råi, h·y gióp ta tiªu diÖt Ýt HuyÕt C« L©u, cã thÓ ta sÏ kh«i phôc trÝ nhí.",
				tTaskIndex = {8, 9}, --Ê¹ÓÃµÄÈÎÎñ±äÁ¿Ë÷Òý¼ÇÂ¼É±¹Ö¸öÊý
				KillNpc = {
					[1] = {
						{399, "HuyÕt C« L©u", "Thiªn s­ bÝ c¶nh"},
					},
					[2] = {
						{399, "HuyÕt C« L©u", "Thiªn s­ bÝ c¶nh"},
					},
