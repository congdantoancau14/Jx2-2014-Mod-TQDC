...
function g_online_npc_main(tbSay, id, bTag)
	if type(tbSay) ~= "table" then return end
...
function fakct_Award201501_GetAward_1()
	gf_Modify("Exp", 99000000);
	AwardGenuineQi(100);
	gf_WriteLogEx("Hoat dong phu thang 1 nam 2015", "§æi phÇn th­ëng ­u ®·i", 1, "PhÇn th­ëng ­u ®·i 1");
end

function fakct_Award201501_GetAward_2()
	...
	gf_EventGiveRandAward(tAward, gf_SumRandBase(tAward), 1, "Ho¹t ®éng phô th¸ng 1 n¨m 2015", "Ho¹t ®éng phô th¸ng 1 n¨m 2015")
	gf_WriteLogEx("Hoat dong phu thang 1 nam 2015", "§æi phÇn th­ëng ­u ®·i", 1, "PhÇn th­ëng ­u ®·i 2");
end
...
function fakct_Award201503_GetAward()
	...
	gf_WriteLogEx("Hoat dong phu thang 3 nam 2015", "§æi phÇn th­ëng ­u ®·i", 1, "PhÇn th­ëng ­u ®·i 2");
end
...
function fakct_Award201503_GetAward_advanced_daily()
	...
	gf_WriteLogEx("Hoat dong phu thang 4 nam 2015", "§æi phÇn th­ëng ­u ®·i", 1, "PhÇn th­ëng ­u ®·i 2");
end