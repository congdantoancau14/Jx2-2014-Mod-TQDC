...
Vet_ExcAw_Say_Tb = {
	"T¹i h¹ muèn ®æi 25 B¸nh ó Tro lÊy phÇn th­ëng (tèn 25 Vµng)/exchange_one",
	"TaÞ h¹ muèn ®æi 25 B¸nh ó Tro §Ëu §á lÊy phÇn th­ëng (tèn 25 Vµng)/exchange_two",
	"T¹i h¹ muèn ®æi c¶ 2 lo¹i trªn lÊy phÇn th­ëng (tèn 25 Vµng)/exchange_both",
};

VET_201205_ExcAw_TaskGroup = TaskManager:Create(10,13);
