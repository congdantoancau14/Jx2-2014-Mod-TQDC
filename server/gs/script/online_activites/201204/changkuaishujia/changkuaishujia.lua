...
Vet_CKSJ_Say_Tb = {
	"T¹i h¹ muèn ®æi 25 Cocktail 7 mµu lÊy phÇn th­ëng (tèn 25 Vµng)/exchange_qcjwj",
	"T¹i h¹ muèn ®æi 25 Tr¸i C©y ­íp l¹nh lÊy phÇn th­ëng (tèn 25 Vµng)/exchange_bdsg",
	"T¹i h¹ muèn ®æi c¶ 2 thø trªn lÊy phÇn th­ëng (tèn 25 Vµng)/exchange_both",
};
