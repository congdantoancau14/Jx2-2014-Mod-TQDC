...
function OnUse(nItemIdx)
	local tbSay = {
		...
		"Ho¹t ®éng T©n niªn 2009/get_new_year_09_informations",
...
function get_new_year_09_informations()
	SendScript2VM("\\script\\online\\viet_event\\new_year_09\\item\\event_notify_pouch.lua","OnUse()")
end;
