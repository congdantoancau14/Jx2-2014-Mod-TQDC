...
--活动任务变量创建
VET_201108_LAMP_TaskGroup = TaskManager:Create(3,16)
--10分钟间隔
...
function hang_lamp()
	...
	if nLevel < 77 or GetPlayerRoute() == 0 or gf_Check55HaveSkill() == 0 then
		Talk(1, "", VET_201108_STRING_LIST[7])
		return
	end
	--不是同一天，初始化
	local nDay = zgc_pub_day_turn()
	print("hang_lamp >> nDay: "..nDay);
	if nDay ~= VET_201108_LAMP_TaskGroup:GetTask(VET_201108_LAMP_TaskGroup.Day) then
		print("VET_201108_LAMP_TaskGroup:GetTask(VET_201108_LAMP_TaskGroup.Day): "..VET_201108_LAMP_TaskGroup:GetTask(VET_201108_LAMP_TaskGroup.Day));
		--该天的次数置为0
