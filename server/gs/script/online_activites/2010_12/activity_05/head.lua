...
function SB_Announce()
	AddGlobalNews("Thiªn S¬n TuyÕt Yªu dÉn theo tiÓu qu¸i ®· xuÊt hiÖn t¹i §Êu Tr­êng TuyÕt ®¹i n¸o linh ®×nh, c¸c vÞ anh hïng hao kiÖt h·y nhanh chãng ®Õn t×m Xa Phu §Êu Tr­êng TuyÕt t¹i Thµnh §« ®Ó chuyÓn vµo ®Êu tr­êng tuyÕt thu phôc bän chóng",1);
end
...
function SB_Start()
	print("2010_12 >> SB_Start >> begin");
	for i=1, getn(SB_MapList) do
		mf_OpenMission(SB_MISSION_ID, SB_MapList[i]);
	end;
	SB_Announce();
	print("2010_12 >> SB_Start >> end");
end
