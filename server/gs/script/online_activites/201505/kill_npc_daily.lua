...
tbKillNpcDaily.tbTaskGroupId = {1, 22}
...
tbKillNpcDaily.tbLogInfo = {"Ho¹t ®éng 05/2015", "Ho¹t ®éng 05/2015"}
...
{
	szTaskName = "Thu thËp Siro Tr¸i C©y (Ngµy th­êng)",
	...
	szNpcNormalSelection = "Hoµn thµnh nhiÖn vô b×nh th­êng ( tiªu hao 2000 d©u t©y + 2000 l¸ trÎ + 29 tiªu dao ngäc)",
	szNpcAdvanceSelection = "Hoµn thµnh nhiÖm vô cao cÊp (Tiªu hao 2000 D©u T©y + 2000 L¸ Trµ Xanh + 299 Tiªu Dao Ngäc)",
