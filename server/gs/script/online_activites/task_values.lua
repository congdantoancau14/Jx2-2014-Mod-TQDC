...
VET_201009_00_TASK_FLAG_TITLE = 2598 -- MODDED. MAYBE IT IS DUPLICATE WITH OTHERS
...
VET_OLY_TASK3 = 3094 --6个圣火坛每个占5bit，共30位
VET_OLY_TASK4 = 3278 --第一字节，触发鬼火的次数，第二字节，活动标记

--=============火凤系列任务
VEIT_BATTLE_KILL_BOSS_COUNTER = 3282--击杀将军或元帅个数
VEIT_BATTLE_KILL_PLAYER_COUNTER = 3283--击杀玩家个数
