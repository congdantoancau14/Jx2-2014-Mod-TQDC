...
function OnUse(nIndex)
	...
	if nFlag == 0 then
		if Is_In_City_Map() == 1 then
			...
			local nIndex = CreateNpc("C©y Gi¸ng sinh 2d","C©y th«ng noel cÊp 1",GetWorldPos())
			...
			StartTimeGuage("Trang trÝ c©y th«ng",60,0,1)
			gf_EventGiveCustomAward(1,300000,1,"Event trang tri cay thong noel","C©y th«ng gi¸o héi")
			return 1
		else
