...
function main()	
	...
	if VET_201402_TASK:GetTask(VET_201402_TASK.TASK) == 5 then
		...
		Say("B¶o kiÕm l©u l¾m kh«ng sö dông, h·y gióp ta mµi kiÕm, cho ®Õn khi nµo Vµng trong KiÕm táa ¸nh hµo quang ngò.\n<color=gold> tiªu diÖt 399 §Ö Tö Minh Gi¸o \n tiªu diÖt 399 Gian TÕ Minh Gi¸o <color>", 0);
		TaskTip("Tiªu diÖt 399 §Ö Tö Minh Gi¸o");
		TaskTip("Tiªu diÖt 399 Gian TÕ Minh Gi¸o");
		return 
	end
