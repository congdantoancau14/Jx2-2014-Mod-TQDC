...
SKILL = {
	...
	{"skill_display_persist_time",{{1,10},{16,10}}},
	{"skill_valid_object",{{1,6},{16,6}}},
	},

	SKILL_LEVEL_COST_ATTRIB	  =	--技能等级相关消耗属性
	{
	{"cost_mana_point",{{1,40},{2,70},{3,100},{4,60},{5,110},{6,160},{16,260}}}
	},
	...
	damage_factor_d={{1,10},{2,12},{3,14},{4,16},{5,18},{6,20},{16,20}},
	damage_factor_z={{1,40},{3,60},{4,75},{6,125},{16,135}},
	},
