...
SKILL = {
	...
	{
	{"cost_mana_point",{{1,20},{4,50},{5,70},{8,100},{18,100}}}
	},
	...
	{
	{magic="damage_life",
	damage_factor_x={{1,0},{4,0},{5,70},{8,100},{18,120}},
	damage_factor_z={{1,0},{4,0},{5,70},{8,100},{18,120}},
	probability_factor_b={{1,20},{18,20}},
	probability_factor_x={{1,100},{18,100}},
	},
	{magic="damage_knockback",
	damage_factor_z={{1,12},{2,18},{4,36},{5,12},{6,18},{8,36},{18,36}},
	},
	},
