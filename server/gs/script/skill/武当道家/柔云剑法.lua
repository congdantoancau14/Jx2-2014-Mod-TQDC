...
SKILL = {
	...
	{"skill_burst_time",{{1,28},{4,28},{5,30},{6,30},{7,33},{18,33}}},
	...
	{
	{magic="damage_life",
	damage_factor_x={{1,30},{4,60},{5,50},{6,55},{7,50},{8,55},{18,66}},
	damage_factor_z={{1,35},{4,65},{5,55},{6,60},{7,55},{8,60},{18,72}},
