...
buchang_end_date 	= 2047102600;			--²¹³¥½áÊøÊ±¼ä
...
--	end	
	...
	--
	tinsert(strtab,"Ta chØ ®Õn th¨m cËu th«i!/nothing")
	Say("<color=green>§Ö tö thî rÌn L­u<color>: Ta lµ ®Ö tö giái nhÊt cña L­u s­ phô. Ta cã thÓ gióp ng­¬i th¨ng cÊp trang bŞ linh khİ cao cÊp. Ngoµi ra, nÕu ng­¬i cã trang bŞ th­îng cæ thÇn khİ Hoµng §Õ, ta còng cã thÓ thæi thÇn khİ gióp ng­¬i, lµm cho trang bŞ phï hîp víi ng­¬i h¬n. <color=red>L­u ı, nÕu vò khİ cña ng­¬i ®· kİch ho¹t Linh Ph¸ch, sau khi ta tiÕn hµnh thao t¸c, Linh Ph¸ch sÏ bŞ huû.<color>",
		getn(strtab),
		strtab);
end
