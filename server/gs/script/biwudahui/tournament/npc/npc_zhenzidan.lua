...
--	end
	...
	if 1 == _check_to_kuafu_condition() then
		print("npc_zhenzidan.lua >> _check_to_kuafu_condition = 1");
		...
		--BWDH_Change_Map(7100,TB_EXIT[nDirection][2],TB_EXIT[nDirection][3],nil) --1399,2847
		BWDH_Change_Map(7100,1399,2847) --1399,2847
	else
		return 0;
	end
	print("ncp_zhenzidan.lua >> GLB_BW_Goto_Field >> end");
	--cdkey»î¶¯
