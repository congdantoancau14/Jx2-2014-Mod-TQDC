...
function main(ExchangeComing)
	...
	--================================================================
	--05ÄêÊ¥µ®»î¶¯
	if (nDate >= 20051223 and nDate <= 20451228) then
	...
	if (nDate >= 20051231 and nDate <= 20460105) then
	...
	if (nDate >= 20060120 and nDate <=20460205) then
	...
	local nDate = tonumber(date("%Y%m%d"))
	if nDate >= 20060428 and nDate <= 20460430 then
