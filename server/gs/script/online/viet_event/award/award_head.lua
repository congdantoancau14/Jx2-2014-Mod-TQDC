...
function VietSeedBagAwardsEvent12()
		...
		if nDate < 111216 or  nDate >= 411219 then
			return
		end
...
function VietCheckEvent201104()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 110401 and nDate <= 410417 then
		return 1
	end
	return 0
end
...
function VietCheckEvent201105()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 110422 and nDate <= 410529 then
		return 1
	end
	return 0
end
...
function VietCheckEvent201106()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 110617 and nDate <= 410710 then
		return 1
	end
	return 0
end
...
function VietCheckEvent201107()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 110701 and nDate <=410710   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20110714()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 110715 and nDate <=410821   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20110826()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 110826 and nDate <=411002   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20111007()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 111007 and nDate <=411106   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20111216()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 111216 and nDate <=420108   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120116()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120113 and nDate <=420205   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120210()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120210 and nDate <=420304   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120309()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120309 and nDate <=420408   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120413()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120413 and nDate <=420506   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120511()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120511 and nDate <=420610   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120615()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120615 and nDate <=420715   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120720()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120720 and nDate <=420812   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120817()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120817 and nDate <=420909   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20120914()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 120914 and nDate <=421007   then
		return 1
	end
	return 0
end
...
function VietCheckEvent20121012()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 121012 and nDate <=421112   then
		return 1
	end
	return 0
end
function VietCheckEvent20121116()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 121116 and nDate <=421216   then
		return 1
	end
	return 0
end
function VietCheckEvent20121217()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 121221 and nDate <=430120   then
		return 1
	end
	return 0
end
function VietCheckEvent20130125()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 130125 and nDate <=430225   then
		return 1
	end
	return 0
end
function VietCheckEvent20130308()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 130308 and nDate <=430415   then
		return 1
	end
	return 0
end
function VietCheckEvent20130419()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 130419 and nDate <=430512   then
		return 1
	end
	return 0
end
function VietCheckEvent20130517()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 130517 and nDate <=430609   then
		return 1
	end
	return 0
end
function VietCheckEvent20130615()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 130614 and nDate <=430714   then
		return 1
	end
	return 0
end
function VietCheckEvent20130719()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 130719 and nDate <=430819   then
		return 1
	end
	return 0
end
function VietCheckEvent20130823()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 130823 and nDate <=430916   then
		return 1
	end
	return 0
end
function VietCheckEvent20130919()
	local nDate = tonumber(date("%y%m%d"))
	if nDate >= 130919 and nDate <=431013   then
		return 1
	end
	return 0
end
