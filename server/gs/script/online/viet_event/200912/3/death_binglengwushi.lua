...
function OnDeath(nNpcIndex)
    ...
    --Ë¢Ê¥µ®Ê÷
    local nNewIndex = CreateNpc("aoyunshenghuotai", "Th¸nh Háa §µn Hïng VÜ", GetNpcWorldPos(nNpcIndex));
    ...
    for i = 1, 100 do
        local nNewNpcIndex = CreateNpc("Event gi¸ng sinh VN", "Hép quµ gi¸ng sinh", nMapId, nMapX + random(-10, 10), nMapY + random(-10, 10));
