...
function main()
    ...
    if GetTrigger(2509) ~= 0 then
        Talk(1, "", "Tr­íc ®ã b¹n ®· kÝch ho¹t Th¸nh Háa §µn Hïng VÜ, h·y nhÊp Hép Quµ Gi¸ng Sinh ®Ó nhËn th­ëng nµo.");
        return 0;
    end
    ...
    Talk(1, "", "B¹n ®· kÝch ho¹t Th¸nh Háa §µn Hïng VÜ, h·y nhÊp vµo Hép Quµ Gi¸ng Sinh ®Ó nhËn th­ëng nµo");
end
