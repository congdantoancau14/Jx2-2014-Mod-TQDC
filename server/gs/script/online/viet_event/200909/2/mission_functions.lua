...
function MS_ProcessStartedTimer()
	...
	if nLoop == 0 then
		...
		-- tham sè 6: ®iÓm HP
		local tBossParam = {
			    [1] = {"Thá MËp", 25, "Thá MËp", "\\script\\online\\viet_event\\200909\\2\\death_pangtuzi.lua", 20, 5000},   --24
            	[2] = {"chicken_viet", 25, "Gµ MËp", "\\script\\online\\viet_event\\200909\\2\\death_ji.lua", 20, 5000},  --24
            	[3] = {"dark_viet",  25, "VÞt MËp", "\\script\\online\\viet_event\\200909\\2\\death_ya.lua", 20, 5000},  --24
            	[4] = {"ship_viet", 25, "Dª MËp", "\\script\\online\\viet_event\\200909\\2\\death_yang.lua", 20, 5000},  --24
            	[5] = {"§¹i Niªn Thó", 25, "§¹i Niªn Thó", "\\script\\online\\viet_event\\200909\\2\\death_niansou.lua", 1, 30 * 60 * 100}   	 -- 4
		}		
        
        local tGoldBossParam = {        	
        		[2] = {"TiÓu kª", "Gµ MËp Hoµng Kim", "\\script\\online\\viet_event\\200909\\2\\death_goldboss.lua", 1, 500},
        		[3] = {"TiÓu ¸p", "VÞt MËp Hoµng Kim", "\\script\\online\\viet_event\\200909\\2\\death_goldboss.lua", 1, 500},
        		[4] = {"TiÓu d­¬ng", "Dª MËp Hoµng Kim", "\\script\\online\\viet_event\\200909\\2\\death_goldboss.lua", 1, 500},
        	}
