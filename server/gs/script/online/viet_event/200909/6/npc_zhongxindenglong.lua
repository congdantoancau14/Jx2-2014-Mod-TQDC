...
function main()
	...
	if nDate >= 20091001 and nDate <= 20491004 then
		tinsert(t_dialog,1,"NhËn phÇn th­ëng dµnh cho Bang chñ/get_token")
	end
	Say("Sù kiÖn Trung Thu 2009 b¾t ®Çu diÔn ra tõ ngµy 18-09-2009 ®Õn hÕt ngµy 25-10-2009. "
	.."Trong thêi gian nµy, ®ång ®¹o cã thÓ tham gia vµo c¸c sù kiÖn næi bËt nh­: "
	.."ChÕ biÕn B¸nh Trung Thu, vui cïng §Ìn KÐo Qu©n vµ Thá BÐo ó, tham gia tiªu diÖt Muçi §éc, "
	.."Trång C©y H¹nh Phóc, xÐt th­ëng theo ®iÓm danh väng vµ ®iÓm s­ m«n ®Ó së h÷u nh÷ng phÇn th­ëng cùc khñng.\n"
	.."Chóc ®ång ®¹o cã mét ®ªm Trung Thu Êm ¸p bªn ng­êi th©n vµ gia ®×nh!", getn(t_dialog), t_dialog);
end
...
function get_token()
	local nDate = tonumber(date("%Y%m%d"))
	if nDate >= 20091001 and nDate <= 20491007 then
