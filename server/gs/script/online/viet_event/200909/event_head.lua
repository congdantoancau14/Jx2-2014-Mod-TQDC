...
function GiveNghichLanDauHon()
	if random(10) == 1 then
		...
		gf_AddItemEx2({2,1,1156,1},"NghÞch l©n","Hoat dong Tet Nguyen Dan","giÕt thó",15*24*3600);
	end
	if random(1,100) == 1 then
		--AddItem(2,1,1157,1) -- §Êu hån
		gf_AddItemEx2({2,1,1157,1},"§Êu hån","Hoat dong Tet Nguyen Dan","giÕt thó",15*24*3600);
	end
end;
...
function Viet0909_Add_ShaQi()
	...
	Msg2Player("B¹n nhËn ®­îc 5 ®iÓm s¸t khÝ fix by thanhduongjokoe");
