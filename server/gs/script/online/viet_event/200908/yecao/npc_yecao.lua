...
szNpcName = gf_FixColor("D¹ Th¶o: ",2);
...
function page1()
	...
	if nDate <= 20400606 then
		tinsert(tbSayDialog, "* Ta muèn mua 1 §Þnh Hån Thiªn Th¹ch (cÇn 4 §ång TiÒn Vµng + 4 Tói Thiªn Th¹ch Tinh Th¹ch + 4 Hoµng Kim §¹i Hång Bao + 4 Tö Kim Hång Bao)\n/get_soulstone")
	end
	tinsert(tbSayDialog, "* Ta muèn ®æi ChiÕn T­îng Nguyªn So¸i/#buy_elephant(0)")
	if nDate >= 20130528 and nDate <= 20430530 then
...
function page3()
	local tbSayDialog = {}
	local nSaySize = 0
	local szSayHead = szNpcName.."ChiÕn m· lµ thó c­¬~i ®Æc thï cña D­¬ng Gia";
