...
function main()
	...
	local strtab = {
		...
		"Ta muèn rót Linh Th¹ch khái trang bÞ/chouqu_lingshi",
		"Ta muèn l·nh <b¶o ®iÓn B¸t Qu¸i>/bagua_baodian",
		"Ta muèn thØnh gi¸o mét sè ®iÒu/askForInfomation",
		}
	...
	Say("<color=green>"..sNowNpc.."<color>: chÝnh lµ ta "..sNowNpc.."Ta cßn cã hai huynh ®Ö, "
		..sXiongDi..", lµ truyÒn nh©n cña C«ng trÞ thÕ gia, ta vµ l·o L­u ë T­¬ng D­¬ng ®· nghiªn cøu chÕ t¹o thµnh c«ng Linh Th¹ch truyÒn thuyÕt vµ bé trang bÞ B¸t Qu¸i thÇn kú. Ngoµi ra cßn chÕ ra chøc n¨ng <color=red>B¸t Qu¸i lÊy Linh Th¹ch<color>. Kh«ng tin , h·y nhÊn chän <color=green>LÊy Linh Th¹ch<color> xem thö tin tøc!",
		getn(strtab),
		strtab)
end
...
function askForInfomation()
	tSay = {
		"Ta muèn t×m hiÓu c¸ch rót linh th¹ch/how_chouqu",
		"Ta muèn hái vÒ hîp thµnh bé B¸t Qu¸i/detail_bagua",
		"Lµm sao nhËn ®­îc Nguyªn Th¹ch, Linh Th¹ch vµ Linh Th¹ch phèi ph­¬ng?/ziyuanhuode",
		"µ kh«ng. C¸i kh¸c c¬/main",
		"V·n bèi chØ hái ch¬i th«i, ®a t¹ tiÒn bèi/nothing",
	};
	Say(szNpcName.."C¸c h¹ muèn hái vÒ ®iÒu g×?",getn(tSay),tSay);
end;
...
function bagua_baodian()
	...
	if GetItemCount(2,1,2639) >= 1 then
		Talk(1,"","<color=green>"..sNowNpc.."<color>: Ch¼ng ph¶i ng­¬i ®· cã mét quyÓn råi sao?");
	elseif AddItem(2,1,2639,1) == 1 then
		Msg2Player("B¹n nhËn ®­îc mér B¸t Qu¸i B¶o ®iÓn");
		Talk(1,"","<color=green>"..sNowNpc.."<color>: 'B¸t Qu¸i B¶o ®iÓn' nµy ghi chÐp liªn quan ®Õn bé B¸t Qu¸i!");
	end 
end
