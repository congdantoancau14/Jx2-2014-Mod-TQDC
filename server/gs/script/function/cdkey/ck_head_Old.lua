...
function GetNBDD1()
	...
	Say(CK_NPC_NAME.."H·y chän lo¹i 1 cÇn:", getn(tDialog), tDialog);
end
...
function GetNBDD2()
	...
	tinsert(tDialog, "\nT«i chØ xem xem th«i/nothing");
	Say(CK_NPC_NAME.."H·y chän lo¹i 2 cÇn:", getn(tDialog), tDialog);
end
function GetNBDD2_Do(nIndex2)
	gf_AddItemEx2(CK_YAOYANG_JIEZI_2[nIndex2][2], CK_YAOYANG_JIEZI_2[nIndex2][1], "CDKEY", "CDKEY", 0, 1)
	
	SetLevel(90, 1);
	AddItem(2,1,270,1); --Bo 3 B¹ch, Tam, Lôc
	AddItem(2,1,1097,1);
	AddItem(2,1,1064,1);
...
function ck_ScoreAward_func_2(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 2000000, 160, 160, 1400, 0)..",".."Nãn Chi?n Cuång (Theo kiÓu h×nh, l­u ph¸i)"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
...
function ck_ScoreAward_func_4(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 4000000, 280, 280, 2200, 0)..",".."¸o Chi?n Cuång (Theo kiÓu h×nh, l­u ph¸i)"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if gf_Judge_Room_Weight(3, 100, " ") ~= 1 then
...
function ck_ScoreAward_func_6(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 6000000, 400, 400, 3000, 0)..",".."QuÇn Chi?n Cuång (Theo kiÓu h×nh, l­u ph¸i)"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if gf_Judge_Room_Weight(3, 100, " ") ~= 1 then
...
function ck_ScoreAward_func_9(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 9000000, 580, 580, 4200, 0)..",".."ChuyÓn sinh 5 cÊp 90"..",".."Vò KhÝ Chi?n Cuång (Theo kiÓu h×nh, l­u ph¸i)"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if tonumber(nCurScore) < tonumber(nNeedScore) then
...
function ck_ScoreAward_func_10(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 10000000, 580, 580, 4200, 0)..",".."Nãn V« H¹ Hµo HiÖp (Theo kiÓu h×nh, l­u ph¸i)"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if tonumber(nCurScore) < tonumber(nNeedScore) then
...
function ck_ScoreAward_func_12(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 12000000, 580, 580, 4200, 0)..",".."ChiÕn Hµi Ngò Hµnh (Tù chän)"..",".." trang søc V« H¹ Hµo HiÖp"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if tonumber(nCurScore) < tonumber(nNeedScore) then
...
function ck_ScoreAward_func_13(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 18000000, 580, 580, 4200, 0)..",".."UÈn Linh CÊp 5"..",".."¸o V« H¹ Hµo HiÖp (Theo kiÓu h×nh, l­u ph¸i)"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if tonumber(nCurScore) < tonumber(nNeedScore) then
...
function ck_ScoreAward_func_14(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 28000000, 580, 580, 4200, 0)..",".." trang søc V« H¹ Hµo HiÖp"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if tonumber(nCurScore) < tonumber(nNeedScore) then
...
function ck_ScoreAward_func_15(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 32000000, 580, 580, 4200, 0)..",".."QuÇn V« H¹ Hµo HiÖp  (Theo kiÓu h×nh, l­u ph¸i)"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if tonumber(nCurScore) < tonumber(nNeedScore) then
...
function ck_ScoreAward_func_17(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = format("Kinh nghiÖm %s, danh väng %d, ®iÓm s­ m«n %d, ®iÓm c«ng tr¹ng %d, ®iÓm ch©n khÝ %d", 40000000, 580, 580, 4200, 0)..",".."Vò khÝ V« H¹ Hµo HiÖp (theo d¸ng ng­êi l­u ph¸i)"..",".."Trøng Linh Thó-Trung"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if tonumber(nCurScore) < tonumber(nNeedScore) then
...
function ck_ScoreAward_func_20(nCurScore, nNeedScore, bTalk)
	if not bTalk then
		...
		local Msg = "Danh hiÖu [NhiÖm Vô §¹t Nh©n]"
		Say(CK_NPC_NAME..format("HiÖn t¹i cã thÓ nhËn phÇn th­ëng:\n   <color=green>%s<color>\n<color=red>Khi kh«ng thÓ cho thªm phÇn th­ëng th× sÏ dïng ®iÓm kinh nghiÖm ®Ó thay thÕ<color>", Msg), getn(tSay), tSay);
		return 0;
	end
	if tonumber(nCurScore) < tonumber(nNeedScore) then
