...
CK_START_ACT = {2020,11,22,0,0,0}; --¼¤»î½ØÖ¹Ê±¼ä
CK_END_TIME = {2024,1,21,0,0,0}; --»î¶¯½ØÖ¹Ê±¼ä
...
CK_JS_GUAIYI = {
	{"Choµng Du HiÖp", {0, 152, 26, 1, 4}},
	{"Choµng ThiÕt HuyÕt", {0, 152, 27, 1, 4}},
	{"Choµng V©n Du", {0, 152, 28, 1, 4}},
}
CK_JS_HUIZHANG = { 
	{"Huy Ch­¬ng Du HiÖp", {0, 153, 26, 1, 4}},
	{"Huy Ch­¬ng ThiÕt HuyÕt", {0, 153, 27, 1, 4}},
	{"Huy Ch­¬ng V©n Du", {0, 153, 28, 1, 4}},
}
CK_JS_SHOE = {
	{"ChiÕn Hµi Du HiÖp", {0, 154, 26, 1, 4}},
	{"ChiÕn Hµi ThiÕt HuyÕt", {0, 154, 27, 1, 4}},
	{"ChiÕn Hµi V©n Du", {0, 154, 28, 1, 4}},
}
...
function ck_GiveRandGem456()
	...
	local VET_RandGem456 = {
        ...
        {1,2, "HuyÕtTrÝchTh¹ch Lv6", {2,22,106,1},nil,nil,nil,1},
        {1,2, "NguyÖtB¹chTh¹ch Lv6", {2,22,206,1},nil,nil,nil,1},
        {1,2, "Hæ Ph¸ch Th¹ch CÊp 6", {2,22,306,1},nil,nil,nil,1},
        {1,2, "H¾c DiÖu Th¹ch CÊp 6", {2,22,406,1},nil,nil,nil,1},
	} 
