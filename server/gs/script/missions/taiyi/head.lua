...
TYT_DROP_BOX_AWARD = {
	[eMSName.FOREST] = {
		[eDifType.NORMAL] = {
--			[1] = {
--				{"tongbaoxiang", "Í­±¦Ïä", 1, "\\script\\missions\\taiyi\\box\\tong_box_1.lua"},
--				{"yinbaoxiang", "Òø±¦Ïä", 4, "\\script\\missions\\taiyi\\box\\yin_box_1.lua"},
--			},
--			[2] = {
--				{"tongbaoxiang", "Í­±¦Ïä", 1, "\\script\\missions\\taiyi\\box\\tong_box_2.lua"},
--				{"yinbaoxiang", "Òø±¦Ïä", 4, "\\script\\missions\\taiyi\\box\\yin_box_1.lua"},
--			},
--			[3] = {
--				{"jinbaoxiang", "½ð±¦Ïä", 1, "\\script\\missions\\taiyi\\box\\jin_box_1.lua"},
--			},
			[1] = {
				{4, 1}, --box_id,num
				{12, 4},
...
--			[1] = {
--				{"tongbaoxiang", "Í­±¦Ïä", 1, "\\script\\missions\\taiyi\\box\\tong_box_3.lua"},
--				{"yinbaoxiang", "Òø±¦Ïä", 4, "\\script\\missions\\taiyi\\box\\yin_box_1.lua"},
--			},
--			[2] = {
--				{"tongbaoxiang", "Í­±¦Ïä", 1, "\\script\\missions\\taiyi\\box\\tong_box_3.lua"},
...
--			},
--			[3] = {
--				{"jinbaoxiang", "½ð±¦Ïä", 1, "\\script\\missions\\taiyi\\box\\jin_box_2.lua"},
--			},
		},
		[eDifType.HARD] 	= {
			[1] = {
...
TYT_JOIN_COST_ITEM = {
	[eMSName.FOREST] = {
		...
		[eDifType.HARD] 	= {{2, 97, 236, 4},"Thiªn Kiªu LÖnh"},
	},
	[eMSName.TOWER] = {
