...
--		else
			...
			if CHEAT_MODE ~= 1 and (nHour < 19 or (nHour == 19 and nMin < 30)) then
...
function canjia_leitai()
	...
	print("siege_arena_mission >> canjia_leitai >> nState: "..nState);
	if CHEAT_MODE ~= 1 and nState == NO_START then
