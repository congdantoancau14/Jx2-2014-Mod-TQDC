...
T_BOX={
	...
	[200131221] = {T_WULING_FREE, T_WULING_IB,},--ÎäÁÖÀñ°ü
	[200131222] = {T_HAOXIA_FREE, T_HAOXIAO_IB},----ÎäÁÖºÀÏÀÀñ°ü
}
...
function onInputNumCallBack_200131221_1(nNum)
	onOpenBoxReal(nNum,200131221,1)
end
function onInputNumCallBack_200131221_2(nNum)
	onOpenBoxReal(nNum,200131221,2)
end
function onInputNumCallBack_200131222_1(nNum)
	onOpenBoxReal(nNum,200131222,1)
end
function onInputNumCallBack_200131222_2(nNum)
	onOpenBoxReal(nNum,200131222,2)
end
