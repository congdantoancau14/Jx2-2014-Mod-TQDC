...
--	end
	...
	tinsert(SayTable, "Nhê tæng qu¶n ®­a t¹i h¹ vµo Tö cÊm ®iÖn/goZiJinDian")
	tinsert(SayTable, "Bæn so¸i muèn vµo Hoµng cung gi¸o tr­êng/goHuangGongXiaoChang")
