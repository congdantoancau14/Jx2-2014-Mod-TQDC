...
function main()
	Say("L·o cã thÓ gióp g× cho quý kh¸ch ®©y??", 2,
--		"ÎÒÏëÊ¹ÓÃ½ð±Ò³äÓÎÏ·Ê±¼ä£¡/select_charge_style",
		"Ta muèn sö dông Kim tÖ ®Ó n¹p thêi gian ch¬i game/select_charge_style",
...
--		"ÎÒÏë×Ô¼ºÊäÈëÒªÊ¹ÓÃµÄ½ð±ÒÊýÁ¿/customize_charge_input",
		"Ta muèn nhËp sè l­îng xu cô thÓ/customize_charge_input",
