...
--	Say(strSay[1], 3, strSay[2], strSay[3], strSay[4])
	...
	local strSay = {
		"<color=green>B¸n ngùa<color>: Vi. "..nSex.." nµy, chç ta co' b¸n toµn lµ lo¹i ngùa tèt ngµn dÆm. Xin mêi xem thö",
		"Cho ta xem/Buy",
		"H·y cho ngùa cña ta ¨n/Feed",
		"Ta chØ tiÖn ghe' ch¬i th«i/Leave",
	}
	Say(strSay[1], 3, strSay[2], strSay[3], strSay[4])
end
