...
t_kuafu_guide_npc_pos_ggs = {
	{8899, 1290, 2693, "Vâ L©m Minh Chñ1", "Lien Dau Tiep Dan Quan", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{8899, 1431, 2809, "Vâ L©m Minh Chñ1", "Lien Dau Tiep Dan Quan", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{8899, 1512, 2720, "Vâ L©m Minh Chñ1", "Lien Dau Tiep Dan Quan", "\\script\\exchg_server\\exchg_server_npc.lua"},
	{8899, 1347, 2592, "Vâ L©m Minh Chñ1", "Lien Dau Tiep Dan Quan", "\\script\\exchg_server\\exchg_server_npc.lua"},
}
--¿ç·ş±¨ÃûÈË1
t_kuafu_join_npc_pos1_ggs={
	{8899, 1310, 2671, "KFZC_songshangbing", "ChiÕn tr­êng liªn ®Êu","\\script\\missions\\kuafu_battle\\npc\\kf_jieyinren.lua"},
	{8899, 1403, 2778, "KFZC_songshangbing", "ChiÕn tr­êng liªn ®Êu","\\script\\missions\\kuafu_battle\\npc\\kf_jieyinren.lua"},
	{8899, 1483, 2723, "KFZC_songshangbing", "ChiÕn tr­êng liªn ®Êu","\\script\\missions\\kuafu_battle\\npc\\kf_jieyinren.lua"},
	{8899, 1376, 2588, "KFZC_songshangbing", "ChiÕn tr­êng liªn ®Êu","\\script\\missions\\kuafu_battle\\npc\\kf_jieyinren.lua"},
}
--¿ç·ş±¨ÃûÈË2
t_kuafu_join_npc_pos2_ggs={
	{8899, 1310, 2714, "Tèng T­íng Qu©n", "§¹i Sø Bang Ph¸i","\\script\\ÊÀ½çµØÍ¼\\¿ç·şÑİÎä³¡\\npc\\tong_ambassagor.lua"},
	{8899, 1413, 2828, "Tèng T­íng Qu©n", "§¹i Sø Bang Ph¸i","\\script\\ÊÀ½çµØÍ¼\\¿ç·şÑİÎä³¡\\npc\\tong_ambassagor.lua"},
	{8899, 1501, 2724, "Tèng T­íng Qu©n", "§¹i Sø Bang Ph¸i","\\script\\ÊÀ½çµØÍ¼\\¿ç·şÑİÎä³¡\\npc\\tong_ambassagor.lua"},
	{8899, 1358, 2588, "Tèng T­íng Qu©n", "§¹i Sø Bang Ph¸i","\\script\\ÊÀ½çµØÍ¼\\¿ç·şÑİÎä³¡\\npc\\tong_ambassagor.lua"},
}
--¿ç·ş±¨ÃûÈË3
t_kuafu_join_npc_pos3_ggs = {
	{8899, 1330, 2695, "EYT_NPC", "Ng­êi tiÕp dÉn ¢n O¸n §µi","\\script\\missions\\eyt_battle\\join_npc.lua"},
	{8899, 1387, 2802, "EYT_NPC", "Ng­êi tiÕp dÉn ¢n O¸n §µi","\\script\\missions\\eyt_battle\\join_npc.lua"},
	{8899, 1490, 2755, "EYT_NPC", "Ng­êi tiÕp dÉn ¢n O¸n §µi","\\script\\missions\\eyt_battle\\join_npc.lua"},
	{8899, 1359, 2618, "EYT_NPC", "Ng­êi tiÕp dÉn ¢n O¸n §µi","\\script\\missions\\eyt_battle\\join_npc.lua"},
}
