...
function showPosList(nRate)
	...
	tinsert(tSay,format("T©y (%d)/#move(%d,0,%d)",-STEPLENGTH*nRate,-STEPLENGTH*nRate,nRate));
	tinsert(tSay,format("§«g (+%d)/#move(%d,0,%d)",STEPLENGTH*nRate,STEPLENGTH*nRate,nRate));
	tinsert(tSay,format("B¾c (%d)/#move(0,%d,%d)",-STEPLENGTH*nRate,-STEPLENGTH*nRate,nRate));
	tinsert(tSay,format("Nam (+%d)/#move(0,%d,%d)",STEPLENGTH*nRate,STEPLENGTH*nRate,nRate));
