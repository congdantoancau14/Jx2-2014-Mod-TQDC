...
SetPhrase(1, "Mäi ng­êi cïng lªn nµo! Ng­êi ®«ng søc m¹nh! :F")
SetPhrase(2, "Nguy hiÓm! Ch¹y mau! :$")
SetPhrase(3, "Mau gióp t«i t¨ng m¸u! :M")
SetPhrase(4, "Cã ai muèn tæ ®éi víi t«i kh«ng? T«i c« ®¬n qu¸! ^o^")
SetPhrase(5, "Hµng míi ra lß cßn nãng hæi ®©y! :E")
SetPhrase(6, "Ng­¬i ë ®©u ®Õn? CÊp mÊy råi? :o")
SetPhrase(7, "C¸c vÞ ®¹i hiÖp! Lµm ¬n cho xin Ýt tiÒn ®i! :)")
SetPhrase(8, "T¹i h¹ lµ ng­êi míi! Xin mäi ng­êi quan t©m chØ gi¸o :I")
SetPhrase(9, "§ang ë ®©u vËy? :S")
